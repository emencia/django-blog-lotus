# Generated by Django 3.1.7 on 2021-04-04 00:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead', models.TextField(blank=True, help_text='Lead paragraph, mostly used for SEO purposes.', verbose_name='lead')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(db_index=True, default='en', max_length=8, verbose_name='language')),
                ('status', models.SmallIntegerField(choices=[(0, 'draft'), (10, 'available')], db_index=True, default=0, help_text='Publication status.', verbose_name='status')),
