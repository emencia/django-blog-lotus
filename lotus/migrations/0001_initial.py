# Generated by Django 3.2.9 on 2022-01-01 21:16
# Edited to replace choices and defaults with some callables
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.ForeignKey(blank=True, default=None, help_text='Mark this article as a translation of an original article.', null=True, on_delete=django.db.models.deletion.CASCADE, to='lotus.article', verbose_name='original article')),
